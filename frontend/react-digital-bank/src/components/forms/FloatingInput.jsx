export function FloatingInput(props){
    ...
    let inputClass = "appearance-none block py-2.5 px-0 w-full text-sm text-gray-100 bg-transparent border-0 border-b-2 border-gray-100 appearance-none focus:outline-none focus:ring-0 focus:border-indigo-600 peer  focus:placeholder-gray-500 placeholder-transparent"
